...
CREATE TABLE `parasite_reminders` (
  ...
  `pet_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `type` tinyint(4) NOT NULL COMMENT '类型：0-自定义 1-体内驱虫 2-体外驱虫 3-体内外驱虫',
  `custom_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '自定义驱虫名称',
