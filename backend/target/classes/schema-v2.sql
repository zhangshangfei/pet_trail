...
CREATE TABLE IF NOT EXISTS `posts_00` (
...
-- 点赞表（按 user_id 分 16 个表：post_likes_00 ~ post_likes_15）
CREATE TABLE IF NOT EXISTS `post_likes_00` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- 评论表（按 post_id 分 16 个表：post_comments_00 ~ post_comments_15）
CREATE TABLE IF NOT EXISTS `post_comments_00` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `post_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
...
-- 打卡记录表（按月分表：checkin_records_202401 ~）
CREATE TABLE IF NOT EXISTS `checkin_records_202401` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
...
-- 步数记录表（按月分表）
CREATE TABLE IF NOT EXISTS `step_records_202401` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
  `pet_id` bigint(20) DEFAULT NULL,
...
-- 饮水记录表（按月分表）
CREATE TABLE IF NOT EXISTS `water_records_202401` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
  `pet_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vaccine_reminders` (
  ...
  `status` tinyint(4) DEFAULT '1' COMMENT '状态：1-待接种 2-已接种 3-已取消',
...
CREATE TABLE IF NOT EXISTS `parasite_reminders` (
  ...
  `status` tinyint(4) DEFAULT '1' COMMENT '状态：1-待驱虫 2-已完成 3-已取消',
